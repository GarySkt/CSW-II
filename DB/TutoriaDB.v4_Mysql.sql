...
CREATE TABLE Entidad (	
	EntidadID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	RolID		INT NOT NULL,
...
CREATE TABLE Escuela (
	EscuelaID		INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	Nombre			VARCHAR(150) NOT NULL,
	Acronimo		varchar(10) NOT NULL,
...
CREATE TABLE EntidadCiclo (
	EntidadCicloID	INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	EntidadID		INT NOT NULL,
...
CREATE TABLE Especialidad (
	EspecialidadID	INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	Nombre			VARCHAR(150) NOT NULL,
	Descripcion		VARCHAR(300) NOT NULL
);

CREATE TABLE EspecialidadDocente (
	EspecialidadDocenteID	INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE MedallaTipo (
	MedallaTipoID	INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	Nombre			VARCHAR(150) NOT NULL,	/*oficiales, libres, etc*/
	Descripcion		VARCHAR(300) NOT NULL
);

CREATE TABLE Medalla (
	MedallaID		INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	Nombre			VARCHAR(150) NOT NULL,
...
CREATE TABLE EntregableEstado (
	EntregableEstadoID		INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE EntregableHistoria(
	EntregableHistoriaID	INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE EntregableMedalla (
	EntregableMedallaID		INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	EntregableID			INT NOT NULL,
