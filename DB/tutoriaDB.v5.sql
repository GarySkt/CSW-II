...
CREATE TABLE Configuracion (
	ConfiguracionID	INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	Nombre	VARCHAR(150) NOT NULL,
	Valor	INT NOT NULL
);
...
CREATE TABLE AreaInvestigacion (
	AreaInvestigacionID		INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	Nombre			VARCHAR(150) NOT NULL,
	Descripcion		VARCHAR(300) NOT NULL
);

CREATE TABLE LineaInvestigacion (
	LineaInvestigacionID	INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	Nombre					VARCHAR(150) NOT NULL,
	AreaInvestigacionID		INT NOT NULL,
	Descripcion				VARCHAR(300) NOT NULL,
	FOREIGN KEY (AreaInvestigacionID) REFERENCES AreaInvestigacion(AreaInvestigacionID)
);

CREATE TABLE LineaInvestigacionDocente (
	LineaInvestigacionDocenteID		INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	DocenteID 						INT NOT NULL,
	LineaInvestigacionID			INT NOT NULL,
	FOREIGN KEY (LineaInvestigacionID) REFERENCES LineaInvestigacion(LineaInvestigacionID),
